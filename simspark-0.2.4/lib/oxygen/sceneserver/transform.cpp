/* -*- mode: c++; c-basic-offset: 4; indent-tabs-mode: nil -*-
   ...
   $Id: transform.cpp 331 2013-02-13 08:31:45Z hedayat $
...
{
    boost::shared_ptr<BaseNode> parent = static_pointer_cast<BaseNode>
        (mParent.lock());
...
{
    boost::shared_ptr<BaseNode> parent = static_pointer_cast<BaseNode>(mParent.lock());
