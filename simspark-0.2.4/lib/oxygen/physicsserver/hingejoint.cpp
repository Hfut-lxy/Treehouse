/* -*- mode: c++; c-basic-offset: 4; indent-tabs-mode: nil -*-
   ...
   $Id: hingejoint.cpp 331 2013-02-13 08:31:45Z hedayat $
...
void HingeJoint::OnLink()
{
    ...
    if (mHingeJointImp.get() == 0)
        mHingeJointImp = dynamic_pointer_cast<HingeJointInt>
...
float HingeJoint::GetTorque() const
{
    return mHingeJointImp->GetTorque(mJointID);
}
